...
const sessionId = `logtest-${Date.now()}`;

console.log(`\n🚀 Testing lead creation on PRODUCTION`);
...
async function test() {
  try {
    ...
    const steps = [
      ...
      { stage: 'stage7a', value: 'LogTest' },
      { stage: 'stage7b', value: '0821111111' },
      { stage: 'stage7c', value: 'logtest@test.com' }
    ];
    ...
    console.log('\n⏳ Waiting 5 seconds for background lead creation logs to appear...');
    await new Promise(r => setTimeout(r, 5000));

    console.log('\n✅ Test complete! Now check Railway logs:\n');
    console.log('  railway logs --tail 50\n');
    console.log('Look for:');
    console.log(`  🚀 LEAD CREATION STARTING for session: ${sessionId}`);
    console.log('  💾 Lead created with ID: ...');
    console.log('  ✅ LEAD CREATION COMPLETE for session: ...\n');
