...
export async function createLead(sessionId, brief) {
    ...
    const { data, error } = await db
        ...
        .insert({
            ...
            audit_c_q1: brief.audit_c_q1 || null,
            audit_c_q2: brief.audit_c_q2 || null,
            audit_c_q3: brief.audit_c_q3 || null,
            audit_c_score: brief.audit_c_score || null,
            audit_c_tier: brief.audit_c_tier || null,
