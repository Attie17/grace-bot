 ...
 *
 * Only stage4b (free-text health notes) calls the Claude API — every other
 * stage's question and acknowledgement is fixed copy keyed by stage id.
 */
...
export const FIRST_STAGE_ID = 'stage2';
...
export function buildClinicalBrief(leadData) {
    return {
        ...
        urgency: leadData.urgent ? 'immediate' : 'soon',
        for_whom: leadData.for_whom || null,
        struggle: leadData.struggle || null,
